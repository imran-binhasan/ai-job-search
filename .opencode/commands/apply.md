---
description: Full drafter-reviewer job application workflow. Evaluates fit, drafts CV + cover letter, dispatches a reviewer agent, compiles and inspects PDFs, and ATS-verifies the output.
agent: general
---
